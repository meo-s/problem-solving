...
$x$는 $a<b$인 $...n_bn_a...$ 꼴을 반드시 한번 이상 포함한다. 이때, 집합 $C$의 가정에 따라 $a \lt b$이면 $n_bn_a \leq n_an_b$이므로 $...n_bn_a... \leq ...n_an_b...$이다. 즉, $x$보다 더 큰 자연수가 반드시 존재하므로, $n_1n_2...n_K$의 꼴이 아닌 가장 큰 자연수 $x$는 존재할 수 없다.  
